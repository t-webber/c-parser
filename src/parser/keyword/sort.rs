...
impl TryFrom<(Keyword, Context)> for KeywordParsing {
    ...
    fn try_from((keyword, context): (Keyword, Context)) -> Result<Self, Self::Error> {
        Ok(match keyword {
            ...
            Keyword::Nullptr => Self::Null,
            // functions
            Keyword::Sizeof => Self::Func(Func::Sizeof),
            Keyword::Alignof => Self::Func(Func::Alignof),
            Keyword::StaticAssert => Self::Func(Func::StaticAssert),
            // pushable
            ...
            Keyword::Atomic => Self::Attr(Attr::from(UnsortedAttr::Atomic)),
            Keyword::BigInt => Self::Attr(Attr::from(UnsortedAttr::BigInt)),
            ...
            Keyword::Complex => Self::Attr(Attr::from(UnsortedAttr::Complex)),
            Keyword::Generic => Self::Attr(Attr::from(UnsortedAttr::Generic)),
            Keyword::Noreturn => Self::Attr(Attr::from(UnsortedAttr::Noreturn)),
            Keyword::Constexpr => Self::Attr(Attr::from(UnsortedAttr::Constexpr)),
            Keyword::Decimal64 => Self::Attr(Attr::from(UnsortedAttr::Decimal64)),
            Keyword::Imaginary => Self::Attr(Attr::from(UnsortedAttr::Imaginary)),
            Keyword::Decimal32 => Self::Attr(Attr::from(UnsortedAttr::Decimal32)),
            Keyword::Decimal128 => Self::Attr(Attr::from(UnsortedAttr::Decimal128)),
            Keyword::Bool => Self::Attr(Attr::from(UnsortedAttr::Bool)),
            Keyword::Alignas => Self::Attr(Attr::from(UnsortedAttr::Alignas)),
            Keyword::ThreadLocal => Self::Attr(Attr::from(UnsortedAttr::ThreadLocal)),
            Keyword::Typeof => Self::Attr(Attr::from(UnsortedAttr::Typeof)),
            Keyword::TypeofUnqual => Self::Attr(Attr::from(UnsortedAttr::TypeofUnqual)),
        })
    }
}
