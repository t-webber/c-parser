...
gen_number_test!(
    ...
    numbers_20: "0x1234567AF" => Number::Long(0x1234567AF);
    numbers_22: "12345" => Number::Int(12345);
    numbers_23: "1.23e+10" => Number::Double(1.23e10);
    numbers_24: "4.56e-5" => Number::Double(4.56e-5);
    numbers_25: "7.89E-2" => Number::Double(7.89e-2);
    numbers_26: "1.23E+100" => Number::Double(1.23e100);
    numbers_27: "1.23F" => Number::Float(1.23);
    // numbers_28: "4.56L" => Number::LongDouble(4.56); // long double not supported
    numbers_29: ".5" => Number::Double(0.5);
    numbers_30: "5." => Number::Double(5.);
    numbers_31: "1e10" => Number::Double(1e10);
    numbers_32: "3.45E-2" => Number::Double(3.45e-2);
    numbers_33: "0b11111111" => Number::Int(255);
    numbers_34: "0xABC12345" => Number::UInt(2881561413);
    numbers_35: "04567U" => Number::UInt(2423);
    numbers_36: "1000000000000000LL" => Number::LongLong(1000000000000000);
