...
use crate::keyword::control_flow::node::try_push_semicolon_control;
...
impl Push for ParensBlockCtrl {
    fn push_block_as_leaf(&mut self, ast: Ast) -> Result<(), String> {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_leaf(&ast, self, "parens block");
    ...
    {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_op(&op, self, "parens block");
        debug_assert!(!self.is_full(), "");
        if self.parens.is_some() {
