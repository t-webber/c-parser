...
use crate::symbols::{BracedBlock, ParensBlock};
use crate::tree::Ast;
use utils::display;
...
impl Push for DoWhileCtrl {
    fn push_block_as_leaf(&mut self, ast: Ast) -> Result<(), String> {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_leaf(&ast, self, "do-while");
    ...
    {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_op(&op, self, "do-while");
        debug_assert!(!self.is_full(), "");
        if self.while_found {
