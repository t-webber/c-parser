...
use crate::keyword::attributes::UserDefinedTypes;
...
impl Push for IdentBlockCtrl {
    fn push_block_as_leaf(&mut self, ast: Ast) -> Result<(), String> {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_leaf(&ast, self, "user-defined type");
    ...
    {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_op(&op, self, "user-defined type");
        debug_assert!(!self.is_full(), "");
