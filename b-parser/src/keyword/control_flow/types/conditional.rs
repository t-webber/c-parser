...
use crate::display::{repr_fullness, repr_option};
use crate::keyword::control_flow::node::{ControlFlowNode, try_push_semicolon_control};
use crate::keyword::control_flow::pushable::PushableKeyword;
use crate::keyword::control_flow::traits::ControlFlow;
use crate::keyword::sort::PushInNode as _;
use crate::modifiers::push::Push;
use crate::operators::OperatorConversions;
use crate::symbols::ParensBlock;
use crate::tree::Ast;
...
impl Push for ConditionCtrl {
    fn push_block_as_leaf(&mut self, ast: Ast) -> Result<(), String> {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_leaf(&ast, self, "conditional");
    ...
    {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_op(&op, self, "conditional");
        debug_assert!(!self.is_full(), "");
        if let Some(failure) = &mut self.failure {
            failure.push_op(op)
        } else if self.full_s {
