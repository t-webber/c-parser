...
use crate::display::repr_fullness;
use crate::literal::{Attribute, repr_vec_attr};
use crate::operators::OperatorConversions;
use crate::tree::Ast;
use crate::variable::PureType;
...
/// [`ListInitialiser`](crate::symbols::ListInitialiser)), only on
/// the implementation.
#[derive(Debug)]
pub struct Cast {
    /// Type to cast to
...
impl Cast {
    ...
    /// See [`Operator::precedence`](crate::operators::Operator::precedence)
...
impl ParensBlock {
    ...
    /// Method to push an [`Operator`](crate::operators::Operator)
    /// into a [`ParensBlock`]
    ///
    /// This method handles cases of cast and non-cast operators.
    ///
    /// See
    /// [`Push::push_op`](crate::modifiers::push::Push::push_op) for
    ...
    /// fails, [`Push::push_op`](crate::modifiers::push::Push::push_op)
    ...
    /// [`Variable::take_pure_type`](crate::variable::Variable)), for
    /// instance not to miss that (a+b)*c is meant as a
    /// [`BinaryOperator`](crate::operators::BinaryOperator)! Hence
    ...
    {
        #[cfg(feature = "debug")]
        crate::errors::Print::push_op(&op, self, "parens");
