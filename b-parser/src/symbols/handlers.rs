...
use crate::modifiers::list_initialiser::apply_to_last_list_initialiser;
use crate::modifiers::make_lhs::try_apply_comma_to_variable;
use crate::modifiers::push::Push as _;
use crate::operators::{Binary, BinaryOperator, Ternary, Unary, UnaryOperator};
use crate::tree::Ast;
...
impl Ast {
    ...
    /// Adds the colon of a
    /// [`TernaryOperator`](crate::operators::TernaryOperator).
    ///
