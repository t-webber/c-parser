...
use utils::{ErrorLocation, IntoError as _};

use crate::numbers::parse::OverParseRes;
use crate::numbers::types::arch_types::{
...
macro_rules! parse_number {
    ($location:ident, $nb_type:ident, $literal:tt, $($int:ident)*, $($float:ident)*) => {
        match $nb_type {
            ...
            $(NumberType::$int => $crate::numbers::macros::safe_parse_int!(ERR_PREFIX, $int, $location, $literal.parse::<$int>(), |nb| Number::$int(nb)),)*
