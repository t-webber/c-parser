...
use utils::ErrorLocation;
use crate::numbers::macros::parse_int_from_radix;
use crate::numbers::parse::OverParseRes;
use crate::numbers::types::arch_types::{Int, Long, LongLong, UInt, ULong, ULongLong};
use crate::numbers::types::{ERR_PREFIX, Number, NumberType};
...
/// use crate::numbers::parse::OverParseRes;
/// use crate::numbers::types::{Number, NumberType};
///
/// assert!(
///     to_bin_value("1010", &NumberType::Int, &LocationPointer::from(String::new()))
...
/// );
/// assert!(matches!(
///     to_bin_value("123", &NumberType::Int, &LocationPointer::from(String::new())),
///     OverParseRes::Err(_)
/// ));
/// ```
pub fn to_bin_value(
